        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryNumber = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VatNumber = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine1 = table.Column<string>(type: "nvarchar(126)", maxLength: 126, nullable: false),
                    AddressLine2 = table.Column<string>(type: "nvarchar(126)", maxLength: 126, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Addresses_Contragents_ContragentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_ContragentId",
                table: "Addresses",
                column: "ContragentId");
